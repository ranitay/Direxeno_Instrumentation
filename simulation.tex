...
calculate the correlation between all angle pairs. \RanComment{Add fig of correlstions iso and aniso}
...
\caption{<$\chi^2_\nu$> and its $2\sigma$ band for isotropic emission (black) and for pattern 1 (red). The <$\chi^2_\nu$> for 
...
\caption{The number of events needed for each emission pattern to cross <$\chi^2_\nu$> = 2.1. Here 
