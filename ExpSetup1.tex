...
supply of high voltage (HV) to the PMTs and the data readout are carried out through the 
...
one side and to the detector chamber on another side. \mmd{The next sentence seems a bit unclear, can it be slightly rephrased?: 
Any change in the system (e.g, cooler type or model) requires 
