...
In the DIREXENO system LXe is circulated through a small spherical cavity held in a thick HPFS sphere . The sphere is surrounded (4$\pi$) by PMTs allowing a high resolution spatial and temporal measurement of the scintillation processes of  LXe. The geometrical design of the system simulates a point like source of scintillation photons, so a detailed vertex reconstruction within the LXe drop is unnecessary. (see fig xxx) 

The guiding principles in the design were fast and easy recovery in case of  malfunction and flexibility to upgrade or redesign any part of the system to fulfill the requirement of any future experiment.
This is achieved by a modular design. There are four main building blocks constitutes of the full setup The gas handling system, in normal working mode, drives the xenon from the detector through 
...
to the PMTs and the data readout are carried out through the data acquisition system (DAQ) system.
...
by a diaphragm pump(TODO add footnote) into a hot getter\footnote{MONO-TORR
...
The OV is made of a 10" Conflat (CF) cube, with ports on all six faces (e.g., FT, pumping ports, 
