...
\sout{The p}Photons coming out of the system \sout{will be }\RanComment{are} detected by twenty 1'' square Hamamatsu R8520-406 PMT with an active area of 20.5 mm $\times$ 20.5 mm each. \sout{We pick the PMTs} \RanComment{The PMT are picked/ chosen to have  }  with a minimum quantum efficiency of 30\% at 178 nm. \RanComment{To apply a }For an applied voltage of 900 V the gain of these PMTs \sout{are} is ~ 2 $\times$ 10$^6$. \RanComment{a positive voltage divider, also manufactured by Hamamatsu is used to .. }We use a positive voltage divider, also manufactured by Hamamatsu, to provide high voltage to the PMTs. \RanComment{The} \sout{These 20} PMTs are held with a special aluminum holder, coated with anti-reflection substance. The holder is made of two hemispheres hosting the PMTs in 3 rows all of them pointing to the center of the \RanComment{HPFS} fused-silica sphere. The PMTs are held only via their voltage--divider bases. The bases are held using M2 PEEK screws. 
In Fig.~\ref{fig:pmtholder}, one of the holder--hemispheres with the PMTs \RanComment{is ?} are shown.
